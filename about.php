...
<html>
  <head>
    ...
    <title>About – College of Computer and Information Sciences</title>
      ...
      <div id="main-inner">
        <div id="overview-header">
          <div class="width-limit">
            <h1 id="title-header">Who are We</h1>
        ...
        <div class="preview-banner" style="background-image: url('images/content/about/preview.jpeg')">
          <div class="black-trans-ll-ur"></div>
          <div class="preview-content preview-bottom width-limit">
            <p class="banner-med banner-title caption-left">The Beginning of<br></p>
            <p class="banner-large banner-title caption-left">The College of Computer <br>and Information Science<br></p>
            <p class="banner-small banner-title caption-left"></p>
            <p class="button-holder caption-left">
            <a href="about/ccis-history.php" class="banner-link">
              <button class="init-button-white hover-button-green">DISCOVER</button>
            </a>
            </p>
          </div>
        </div>
        <div id="grid-header">
          <div class="width-limit">
            ...
            <h1 id="title-header">Learn about CCIS</h1>
            <div class="preview-grid grid-2">
              <a href="about/mission-goals.php" class="grid-link swipe-animation">
                <img src="images/content/about/preview-1.jpeg">
                <div class="cover-shade"></div>
                <div class="grid-content">
                  <p class="grid-title">Understand the college's sense of purpose and objectives</p>
                  <p class="read-more">Read More <span class="html-right-arrow">→</span></p>
                </div>
              </a>
              <a href="about/contact-us.php" class="grid-link swipe-animation">
                <img src="images/content/about/preview-2.jpeg">
                <div class="cover-shade"></div>
                <div class="grid-content">
                  <p class="grid-title">Getting in touch is easy!</p>
                  <p class="read-more">Read More <span class="html-right-arrow">→</span></p>
                </div>
              </a>
            </div>
