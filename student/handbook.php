...
<html>
  <head>
    ...
    <title>Student Handbook – College of Computer and Information Sciences</title>
      ...
      <div id="main-inner" class="width-limit">
        <div id="main-column">
          <div id="main-content">
            ...
            <div id="content-body">
              <p>The  PUP  Student  Handbook  is  a  compendium  of  information  on student concerns and interests.<br><br>This  work  serves  as  an  enduring  landmark  of  the  PUP  community, reflecting the external and internal substance of life in the academe.<br><br>The  Handbook  also  echoes  the  sounds  and  nuances  of  learning, including  the  code  of  conduct,  scholastic  standards,  cultural  and  religious guidelines,  and  such  other  policies  and  directives  that  lend  distinction  to PUP as a fount of knowledge and skills.<br><br>Prefaced by the PUP philosophy, vision, and 8-point agenda, the PUP Student Handbook is a veritable gateway to students' holistic development.<br></p>
              <div id="pdf-link-container">
                <a href="../files/handbook/PUP-Student-Handbook-2019.pdf">
                  <div id="pdf-link">
                    <div>
                      <img src="../images/icons/pdf.png" alt="PUP Student Handbook">
                    </div>
                    <div>PUP-Student-Handbook-2019.pdf</div>
                  </div>
                </a>
              </div>
              <div id="pdf-container">
                <iframe src="../files/handbook/PUP-Student-Handbook-2019.pdf" type="application/pdf" width="100%" height="100%"></iframe>
              </div>
            </div>
